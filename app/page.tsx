            ...
            <div className="rounded-b-[6rem] bg-stone-200 size-full flex items-center min-h-screen">
                <div className="container text-center flex flex-col gap-10">
                    ...
                    <div className="space-y-2 flex flex-col">
                        ...
                        <motion.h1
                            className="text-8xl font-black max-w-[40rem] w-full mx-auto"
                            initial="hidden"
                            animate="visible"
                            variants={{
                                hidden: {
                ...
                <div className="space-y-10">
                    <div className="grid grid-cols-2 gap-10 items-center">
                        ...
                        <div className="space-y-8">
                            <h3 className="text-5xl font-medium">Nametopia</h3>
                            <p>
                                Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Aliquam ex, voluptates libero
                                officia quibusdam exercitationem dolorem iusto
                                pariatur tempora commodi minima ad est aut quae
                                vel, autem illum amet aliquid!
                            </p>

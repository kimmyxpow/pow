	...
	<div class="inner border-x border-zinc-300">
		<div class="grid grid-cols-2 gap-8 p-8 sm:grid-cols-3 md:grid-cols-6">
			<div class="col-span-2 flex flex-col gap-2 sm:col-span-3">
				<span class="font-serif text-2xl text-dark">Pow</span>
				<p>Thanks for scrolling this far. You’re rare.</p>
				<div class="flex gap-2">
					<a
						class="text-zinc-600 transition-all hover:text-primary"
			...
			<div class="flex flex-col gap-4">
				...
				<nav class="flex flex-col gap-1">
					<a class="text-zinc-600 hover:text-primary" href="/">Home</a>
					<a class="text-zinc-600 hover:text-primary" href="/projects">Projects</a>
					<a class="text-zinc-600 hover:text-primary" href="/articles">Articles</a>
					<a class="text-zinc-600 hover:text-primary" href="/snippets">Snippets</a>
					<a class="text-zinc-600 hover:text-primary" href="/guest-book">Guestbook</a>
				</nav>
			</div>
			<div class="flex flex-col gap-4">
				<span class="font-serif text-xl text-zinc-700">Personal</span>
				<nav class="flex flex-col gap-1">
					<a class="text-zinc-600 hover:text-primary" href="/about">About</a>
					<a class="text-zinc-600 hover:text-primary" href="/goals">Goals</a>
					<!-- <a class="text-zinc-600 hover:text-primary" href="/contact">Contact Me</a> -->
					<a
						class="text-zinc-600 hover:text-primary"
			...
			<div class="flex flex-col gap-4">
				...
				<nav class="flex flex-col gap-1">
					<a class="text-zinc-600 hover:text-primary" href="/attributions">Attribution</a>
					<a class="text-zinc-600 hover:text-primary" href="/sitemap.xml">Sitemap</a>
					<a class="text-zinc-600 hover:text-primary" href="/visits">Visits</a>
				</nav>
			</div>
		</div>

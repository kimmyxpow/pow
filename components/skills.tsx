        ...
        <div className="flex flex-wrap justify-center gap-8">
            {skills.map((skill) => (
                <Link
                    ...
                    key={skill.name}
                    target="_blank"
                    className="group relative transition-all hover:-translate-y-2"
                >
                    <Icon className="size-8 text-zinc-400 transition-all group-hover:text-zinc-800" icon={skill.icon} />
